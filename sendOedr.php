...
<div class="accdiv">
<table>
     <h4><center><color type='white'><u> Send Drug Order information</u></center></h4>
...
<td> quantity:</td>
<td><input type="number" name="quantity" id="quantity"required placeholder="Enter quantity"/><span id="quantityerror" class="error" ></span></td></tr>
