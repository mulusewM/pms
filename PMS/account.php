...
<tr>
<th align="center" width="250px" height="25px" bgcolor="#336699"><font face="arial" color="white" size="4">??????? ????</font></th>
</tr>
...
<div style="width:420px;  margin:0 auto; position:relative;  solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:0px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 50px rgba(0,0,0,0.4); margin-top:20px; color:#000000;">
 ...
 <div><strong><font color="white" size="4px"font-family="times new romman"; ><center>Create New User Account</center></font></strong></div>
  ...
  <tr>
	       ...
	       <td class='para1_text' width="220px"><font color="red"></font> <b>User ID:</b></td><td>
		   <input type="text"   name="username"   required x-moz-errormessage="Enter Username" ></td>
		 
	     </tr>
		 <tr>
	       <td class='para1_text'><font color="red"></font><b> First Name:</b></td><td><input type="password" name="password" id="password" required x-moz-errormessage="Enter password" maxlength="15"></td>
	     </tr>
	<tr>

	       <td class='para1_text' width="220px"><font color="red"></font> <b>Last Name:</b></td><td>
		   <input type="text"   name="username"   required x-moz-errormessage="Enter Username" ></td>
		 
	     </tr>
		 <tr>
	       <td class='para1_text'><font color="red"></font><b> sex:</b></td><td><input type="password" name="password" id="password" required x-moz-errormessage="Enter password" maxlength="15"></td>
	     </tr>	 
	<tr>

	       <td class='para1_text' width="220px"><font color="red"></font> <b>User Name:</b></td><td>
		   <input type="text"   name="username"   required x-moz-errormessage="Enter Username" ></td>
	...
	<tr>
	       ...
	       <td class='para1_text' width="220px"><font color="red"></font> <b>Confirm Password:</b></td><td>
		   <input type="text"   name="username"   required x-moz-errormessage="Enter Username" ></td>
		 
	     </tr>
		 <tr>
	       <td class='para1_text'><font color="red"></font><b> Role:</b></td><td><input type="password" name="password" id="password" required x-moz-errormessage="Enter password" maxlength="15"></td>
	     </tr>	 
  <tr>
...
<a href="#top"><img src="img/arrow_up.png" width="40px" title="Scroll Back to Top"></a>
        ...
        <p align="center"><font face="Times New Roman" color="white" size="2">Copyright &copy 2010 KMPMS. All rights reserved.</font></p>
		<br><br>
		<div align="center">
