...
<body>
<form action="createaccount_for_meter_reader.php" onsubmit='return formValidator()' method="POST">
  <p><br>
  ...
  <div style="width:400px; margin:0 auto; position:relative; border:3px solid rgba(0,0,0,0); -webkit-border-radius:5px; -moz-border-radius:5px; border-radius:5px; -webkit-box-shadow:0 0 18px rgba(0,0,0,0.4); -moz-box-shadow:0 0 18px rgba(0,0,0,0.4); box-shadow:0 0 18px rgba(0,0,0,0.4); margin-top:20px; color:#000000;">
    <div style="background-color:green; font-family:Arial, Helvetica, sans-serif; color:#00FFFF; padding:5px; height:22px; width:390px;">
      <div style="float:left;">
        <div align="right"><strong>Create Account For Meter Reader</strong></div>
      </div>
    </div>
    <table width="450" height="300" align="center" class="a">
	  <tr>
        ...
        <td width="238"><input  type="text" name="employeeid" id="employeeid" title="Insert Employyee Id Here!"  placeholder="Insert Employee ID!"></td>
      </tr>
	
      <tr>
        <td width="142" height="24" valign="top"><div align="right" class="style4 style10">
       </div>First Name:</td>
        <td width="238"><input name="first_name" type="text" id="first_name"  placeholder="Enter Firstname"></td>
      </tr>
      <tr>
        <td height="24" valign="top"><div align="right" class="style11"></div>Last Name:</td>
        <td><input name="last_name" type="text" id="last_name"  placeholder="Enter Lastname"></td>
      </tr>
      <tr>
        ...
        <td><span style="font-family:Arial, Helvetica, sans-serif; font-size:12px; color:#FF0000; font-weight:bold;" id="errmsg1">
          <input type="text" name="user_name" id="user_name"  autocomplete="off" placeholder="Enter User Name">
        </span></td>
      </tr>
	  ...
	  <tr>
        ...
        <td><input type="text" name="pinnumber" id="pinnumber"  placeholder="Enter Recovery Pin Number"></td>
      </tr>
      <tr>
	   <td></td>
