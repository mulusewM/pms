...
<title>adminrecoveryform</title></head>
<body>
<div class="a">
<h4>Reset Your Account By Filling The Following Feilds!</h4>
<form action="adminrecoveryaccount.php" onSubmit="return formValidator()" method="post">
...
<tr><td>Security Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pinnumber" id="pinnumber" autocomplete="off" Required="Required" placeholder="Insert Your Security Code!" title="Security Code is needed!" /></td></tr>
<tr><td></td></tr>
