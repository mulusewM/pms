...
<table width="500" border="0">
  ...
  <tr><td width="150">First_Name:</td>
      <td><input type="text" name="firs
	  t_name" id="customerfirstname" value="<?php echo $customerfirstname; ?>"/></td></tr>
   
   <tr><td>Last_Name:</td>
    <td><input type="text" name="customerlastname" id="customerlastname" value="<?php echo $customerlastname; ?>" /></td></tr>
	
	<tr><td>kebele:</td>
    <td><input type="text" name="email" id="Kebele" value="<?php echo $Kebele; ?>"/></td></tr>
	
	<tr><td>house_number:</td>
    <td><input type="text" name="housenumber" id="housenumber" value="<?php echo $housenumber; ?>"/></td></tr>
