<html>
<head>
<title>billoficerviewregistration</title>
...
<center><h3>customer Data Table</h3></center>
<?php
...
<th bgcolor='green'>User<br>Name</th>   
...
/*/echo "<td><a rel='facebox' href='Customerapplyregistration.php?id=".$row['customer_id']."'>calculete  Bill<br></a>|";
 echo "<a href='viewpayment.php?meter_id=".$row['customer_id']."'>Generate Bill<br></td>";*/
  echo "</tr>";
  }
echo "</table>";
