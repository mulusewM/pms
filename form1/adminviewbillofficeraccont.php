...
<body>
<br><br><br>
<h3><center>Bill Officer Account</center></h3>
<?php
$conn = mysql_connect("localhost","root") or die(mysql_error());
mysql_select_db("water44", $conn) or die("Can not select Database");
$q = "select * from   creataccountbillofficer";
...
<th bgcolor='skyblue'>Security Number</th>   
...
while($row = mysql_fetch_array($r))
 ...
 echo "<td><a rel='facebox' href='adminupdatebillofficeraccount.php?id=".$row['id']."'>Edit</a>|";
 echo "<a rel='facebox' href='admindeletebilloficceraccount.php?id=".$row['id']."'>Del</td>";
  echo "</tr>";
  }
echo "</table>";
echo "</center>";
