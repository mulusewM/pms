...
$result = mysql_query("SELECT * FROM creataccounttechnicalsupervisor WHERE id = '$user_id'");
...
<p><h3>Update Technical Account Form!!</h3></p>
  <form  action="adminupdatetechnicalaccount.php" onsubmit='return formValidator()' method="post">
<table width="500" border="0">
  ...
  <tr><td width="150">Technical First Name:</td>
