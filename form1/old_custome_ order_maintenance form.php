...
{ 
if (isNumeric(phonenumber, "Please Enter your Valid  phonenumber!")) 
{ 
if (isAlphabet(request, "Please enter only letters for your comment!"))
 {
return true; 
	 }
	 }
...
<title>old customer maintenance order form</title></head>
<body>
<div class="a">
<h2>old customer maintenace order </h2>
<form action="old_custome_ order_maintenance.php" onSubmit="return formValidator()" method="post">
...
<tr><td align="center">customer id&nbsp;&nbsp;&nbsp;<input type="text" id="customerid" name="customerid" required="required" placeholder="Enter customerid" /></td></tr>
<tr><td align="center">meterid&nbsp;&nbsp;&nbsp;<input type="text" id="meterid" name="meterid" required="required" placeholder="Enter meterid" /></td></tr>
...
<tr><td align="center">task&nbsp;&nbsp;&nbsp;<input type="text" id="task" name="request" required="required" placeholder="Enter task" /></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
<tr><td></td></tr>
