...
$result = mysql_query("SELECT * FROM  creataccountbillofficer WHERE id  = '$user_id'");
...
<p><h3>Update Bill Officer Account Form!!</h3></p>
  <form action="adminupdatebillofficer_account.php"  onsubmit='return formValidator()' method="post">
