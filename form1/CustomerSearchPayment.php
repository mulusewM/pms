...
<body>
<form action="CustSearchPayment.php" onsubmit='return formValidator()' method="POST">
<center><h3>Search Consumtion Of Water</h3></center>
...
<td>
		  ...
		  <tr>
	<td><input type="submit" name="submit">&nbsp;<input type="reset" value="Clear" /></td>
	</tr>
</tr>
</table></center>
</form>
