...
<body><br>
<h3><center> Data Table Of Old Customer Order</center></h3>
<?php
$conn = mysql_connect("localhost","root") or die(mysql_error());
mysql_select_db("water44", $conn) or die("Can not select Database");
$q = "select * from  replyforcustomer";   	
...
<th>phonenumber<br>Number</th>
<th>Customer<br>Id Number</th>
<th>replay<br> text</th>
</tr>";
