...
<body>
<form action="searchtechFeedback.php" onsubmit='return formValidator()' method="POST">
<center><h3>Search Technician Feadback From Table!</h3></center>
<center><table class="a">
<tr>
	<td>Search</td>
	<td><input type="text" name="name" id="yourid" placeholder="Enter Your Id" size="20"></td>
