...
$q = "select * from  creataccountmanager";
...
<th bgcolor='skyblue'>Manager ID</th>    		                                    		
...
while($row = mysql_fetch_array($r))
 ...
 echo "<td><a rel='facebox' href='adminupdatemanageraccount.php?id=".$row['id']."'>Edit</a>|";
 echo "<a rel='facebox' href='admindeletemanageraccount.php?id=".$row['id']."'>Del</td>";
  echo "</tr>";
  }
echo "</table>";
echo "</center>";
