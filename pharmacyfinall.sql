...
<title>localhost / localhost / pharmacyfinall | phpMyAdmin 3.1.3.1</title>
<meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
<meta name="robots" content="noindex,nofollow">
<script type="text/javascript">
// <![CDATA[
    // definitions used in common.js
    var common_query = 'token=7b8a5d7d4d847c3a64731f3f8982a68c';
    ...
    var server = '1';
    var table = '';
    var db    = 'pharmacyfinall';
    var token = '7b8a5d7d4d847c3a64731f3f8982a68c';
    var text_dir = 'ltr';
...
<script src="pharmacyfinall_files/common.js" type="text/javascript"></script>
</head>
<frameset cols="200,*" rows="*" id="mainFrameset">
        <frame frameborder="0" id="frame_navigation" src="pharmacyfinall_files/navigation.htm" name="frame_navigation">
        <frame frameborder="0" id="frame_content" src="db_structure.php?db=pharmacyfinall&amp;token=7b8a5d7d4d847c3a64731f3f8982a68c" name="frame_content">
        <noframes>
        <body>
