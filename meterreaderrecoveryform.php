...
<title>meterreaderrecoveryform</title></head>
<body>
<div class="a">
<h2>Reset Your Account By Filling The Following Feilds!</h2>
<form action="meterreaderrecoveryaccount.php" onSubmit="return formValidator()" method="post">
<table border="0" cellspacing="11">
<tr><td>Employee ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  name="employeeid" id="employeeid" placeholder="Insert Your Employee Id!" title="Employee Id is needed!" /></td></tr>
<tr><td>Security Code:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="pinnumber" id="pinnumber" placeholder="Insert Your Security Code!" title="Security Code is needed!" /></td></tr>
<tr><td></td></tr>
