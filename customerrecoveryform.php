...
<script type='text/javascript'>
 ...
 if (iswordNumeric(customer_id, "Please Insert Customer ID!")) 
 {  
...
<title>customerrecoveryform</title></head>
<body>
<div class="a">
<h4>Reset Your Account By Filling The Following Feilds!</h4>
<form action="customerrecoveryaccount.php" onSubmit="return formValidator()" method="post">
<table border="0" cellspacing="11">
<tr><td>Customer ID:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text"  name="customer_id" id="customer_id"Required="Required" placeholder="Insert Your Customer Id!" title="Customer Id is needed!" /></td></tr>
