...
$result = mysql_query("SELECT * FROM   creataccountbillofficer where employeeid= '$employeeid' and pinnumber='$pinnumber'") or die(mysql_error());
...
<body>
<div class="a">
<tr><td><p><h4>Reset Your Account By Inserting The Following Information!</h4></p></td></tr>
  <form  action="billofficerrecovery.php" onSubmit="return formValidator()" method="post">
    <table width="342" border="0">
  <tr>
    <td width="107"></td>
    <td width="315"><input type="hidden" name="id"Required="Required" value="<?php echo $id; ?>" /></td></tr>
	
   
	<tr><td>User Name:</td>
    <td><input type="text" name="user_name" id="user_name"Required="Required" value="<?php echo $user_name; ?>"/></td></tr>
	
	<tr><td>Password:</td>
    <td><input type="text" name="password" id="password"Required="Required" value="<?php echo $password; ?>"/></td></tr>
	
	<tr><td>Security Code:</td>
    <td><input type="text" name="pinnumber" id="pinnumber"Required="Required" value="<?php echo $pinnumber; ?>"/></td></tr>
