...
$result = mysql_query("SELECT * FROM   creataccountadmin where employeeid= '$employeeid' and pinnumber='$pinnumber'") or die(mysql_error());
...
if ($count > 0) 
  ...
  $pinnumber=$row['pinnumber'];
		...
		echo '<script>windows: location="adminrecoveryform.php"</script>';
	     }
		 }
?>
<br /><br /><br />
...
<p><h4>Reset Your Account By Inserting The Following Information!</h4></p>
  <form  action="adminrecovery.php" onSubmit="return formValidator()" method="post">
<table width="342" border="0">
  <tr>
	...
	<tr><td>User Name:</td>
    <td><input type="text" name="user_name"  autocomplete="off" id="user_name" value="<?php echo $user_name; ?>"/></td></tr>
	
	<tr><td>Password:</td>
    <td><input type="text" name="password" id="password" autocomplete="off"  value="<?php echo $password; ?>"/></td></tr>
	
	<tr><td>Security Code:</td>
    <td><input type="text" name="pinnumber" id="pinnumber"  autocomplete="off"value="<?php echo $pinnumber; ?>"/></td></tr>
