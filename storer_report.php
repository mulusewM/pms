...
<br>
				...
				<select  onChange="showDiv('div',this)">
					...
					<option value="6">unavailable Drugs in The store</option>
				</select>
...
<center><div>
	...
	$sel="SELECT * FROM store, user where store.recorder_id= user.user_id";
	$sql=mysql_query($sel);
	...
	echo $dn." "."is not Available in the stock";
	}
	}
	print( "</table>");
	echo"</center>"	;					
...
<div id="div6" style="display:none;">
					<form action="" method="post">
					<u><center><h4>Unavailable drugs in the store</h4></center></u>
						<?php
							   include('connection.php');
