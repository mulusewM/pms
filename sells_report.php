...
<div id="div2" style="display:none;">
	...
	user.user_id=sold_drugs.soldby_id and `sold_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL 1 DAY)AND CURDATE( )");
	...
	print ("<td><font size='2'>" . $last['Fname'] ." ". $last['Lname'] . "</td>");
	...
	$s=mysql_query("select * from sold_drugs,store,stock,user where stock.drugID=store.drugID and stock.stock_id=sold_drugs.stock_id and 
	user.user_id=sold_drugs.soldby_id and `sold_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL 7 DAY)AND CURDATE( )");
...
<div id="div4" style="display:none;">
	...
	and user.user_id=sold_drugs.soldby_id and `sold_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL 1 MONTH)AND CURDATE()");
...
<div id="div5" style="display:none;">
	...
	$s=mysql_query("select * from sold_drugs,store,stock,user where stock.drugID=store.drugID and stock.stock_id=sold_drugs.stock_id 
	and user.user_id=sold_drugs.soldby_id and `sold_date` BETWEEN DATE_SUB(CURDATE(), INTERVAL 1 YEAR)AND CURDATE()");
