...
if(isset($_POST['search']))
    {
					...
					$sql= "SELECT * FROM store,stock where store.drugID=stock.drugID ";
...
echo $msg;
	   ...
	   include('connection.php');
	   $sq="select * from stock WHERE expireDate < '$cd'";
	  ...
	  if($quant > 0){
	   ...
	   $sqq1="update stock set manuDate='null',expireDate='null', transfer_quantity= 'null'  WHERE expireDate < '$cd' ";
