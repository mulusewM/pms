...
$result = mysql_query("SELECT * FROM  creataccounttechnicalsupervisor where employeeid= '$employeeid' and pinnumber='$pinnumber'") or die(mysql_error());
...
<p><h4>Reset Your Account By Inserting The Following Information!</h4></p>
  <form  action="technicianrecovery.php" onSubmit="return formValidator()" method="post">
