...
<div id="sse2">
        ...
        <ul id="unique">
		 <li><p style="margin-left:235px;font: bold 20px times new roman;">Well Come To pharmacist Page<p></li>
		  <li><a href="logout.php" id="log" style="margin-left:200px;">logout</a></li>
...
<br>
				...
				<select  onChange="showDiv('div',this)">
					...
					<option value="6">unavailable Drugs in The stock</option>
				</select>
...
<div id="div6" style="display:none;">
					<form action="" method="post">
					<u><center><h4>Unavailable drugs in the stock</h4></center></u>
						<?php
							   include('connection.php');
