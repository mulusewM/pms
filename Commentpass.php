...
<tr>
	<td>Customer Name:</td><td><input type="text" name="name" id="sender_name"></td>
	<td id="sender_name_error" class="error"></td>
		<td id="sender_name_2" class="error"></td>
</tr> 
<tr>
	<td>Customer Email*:</td><td><input type="email" name="email" id="email"></td>
...
if(isset($_POST['name'])) {
	...
	mysql_query("insert into comment2 values('".$_POST['name']."', '".$_POST['email']."', '".$_POST['body']."')");
