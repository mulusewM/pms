...
mysql_select_db("pharmacyfinal",$con);
       ...
       session_register("myusername");
		...
		else if($role=="storecoordinator")
		{
		$_SESSION['user_id']=$row['user_id'];
        header("location:storecoordinator.php");
		 }
...
<div id="sse2">
        ...
        <ul>
         ...
         <li><a href="pharmacy_final_4.pdf">Help</a></li>
...
<tr>
<td > <img src="slideshow/images/2.png" style="height:200px;"  valign="top"></td>
</tr>
...
<div style="background-color:#336699;border-radius:20px;font-family:Arial, Helvetica, sans-serif; color:#000000; padding:15px; height:30px;"> 
 ...
 <p align="center"><img src="img/login_icon1.gif" title="Member Login" width="100"></p>
  ...
  <tr>
	...
	<td class='para1_text' width="40px" ><b>Username:</b></td>
	 <td><input type="text"   name="user"><td></td></td>	 
 </tr>
 <tr>
	  <td class='para1_text'><font color="red"></font><b> Password:</b><td><input type="password" name="pass" ></td>
	  </tr>
		<tr> 
		<td class='para1_text'><font color="red"></font>
		         <div>
				 <b>role:</b>
				 <select  onChange="showDiv('div',this)">
				    <option value="1">select role type</option>
					<option value="2">Manager</option>
					<option value="3"selected>pharmacist</option>
					<option value="4">Storecoordinator</option>
